...
export async function notifyNewBooking(inquiry: BookingInquiry): Promise<void> {
  ...
  const fromAddress = process.env.RESEND_FROM_EMAIL?.trim() || "Hotel Raghuvar Residency Website <onboarding@resend.dev>";
  ...
  const html = `
    <div style="font-family:sans-serif;font-size:14px;color:#262220;">
      ...
      <p style="color:#4a433d;margin-top:0;">Hotel Raghuvar Residency, Ayodhya</p>

...
export const metadata: Metadata = {
  title: "About Us",
  description: "Learn about Hotel Raghuvar Residency, a premium and comfortable hotel in Ayodhya, Uttar Pradesh.",
      ...
      <div className="container-px mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div className="mt-6 space-y-4 text-sm leading-relaxed text-charcoal-soft">
            <p>
              Located near Ramsewak Puram, Ramghat, Ayodhya, the hotel gives guests a convenient
        ...
        <div className="aspect-[4/5] rounded-2xl overflow-hidden shadow-[var(--shadow-card)]">
          <ImageFallback src={null} alt="Hotel Raghuvar Residency hotel" label="Hotel Raghuvar Residency" className="h-full w-full" />
        </div>
      </div>
    </div>
  );

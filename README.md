# Hotel Raghuvar Residency — Hotel Website

A production-ready website for **Hotel Raghuvar Residency**, Ayodhya, Uttar Pradesh, built with
...
git init
git add .
git commit -m "Initial Hotel Raghuvar Residency website"
git branch -M main
...
- [x] Email address — `raghuvarpalace@gmail.com` (booking notifications go here)
